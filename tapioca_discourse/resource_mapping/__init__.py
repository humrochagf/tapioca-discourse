...
from .about import ABOUT_MAPPING
...
from .emails import EMAILS_MAPPING
from .flags import FLAGS_MAPPING
from .groups import GROUPS_MAPPING
from .invites import INVITES_MAPPING
from .logs import LOGS_MAPPING
...
from .webhooks import WEBHOOKS_MAPPING

RESOURCE_MAPPING = {}
RESOURCE_MAPPING.update(ABOUT_MAPPING)
...
RESOURCE_MAPPING.update(EMAILS_MAPPING)
RESOURCE_MAPPING.update(FLAGS_MAPPING)
RESOURCE_MAPPING.update(GROUPS_MAPPING)
RESOURCE_MAPPING.update(INVITES_MAPPING)
RESOURCE_MAPPING.update(LOGS_MAPPING)
...
RESOURCE_MAPPING.update(WEBHOOKS_MAPPING)
